<template>
    <div>
        <el-tooltip
            class="item"
            effect="dark"
            content="选择年份, 查看年份活跃值热力图. 雷达图可查看项目全年总活跃值. 数据来源: X-lab2017/open-digger"
            placement="top"
        >
            <el-select
                v-model="cdata.year"
...
export default {
    data() {
        return {
            ...
            cdata: {
                ...
                radarData: [],
                radarDataAvg: [
                    2079, 3961, 4482, 5216, 5480, 5183, 4502, 4711, 1191,
                ],
                maxData: 12000,
                weekMaxData: [],
                weekLineData: [],
            ...
            yearActivityData: [{"year":"2020","activity":1436},{"year":"2021","activity":5529},{"year":"2022","activity":5616},{"year":"2023","activity":5601},{"year":"2024","activity":2506}], // New variable to store the array of objects
        };
    },
    components: {
        Chart,
    ...
    methods: {
        async fetchData(path) {
            let activityResponse = await axios.get(
                path + "/active_dates_and_times.json"
            );
        ...
        getFullMonth(datas) {
            // 获取所有的年份
            const years = Object.keys(datas).map((key) =>
        ...
        processData(datas) {
            ...
            this.yearActivityData = this.years.map((year, index) => ({
                year: year,
                activity: this.cdata.radarDataAvg[index],
            }));
        ...
        handleRepoAIClick() {
            ...
            }, 其中该项目的每年的活跃值数据格式为"年份: 值", 数据为${JSON.stringify(
                this.yearActivityData
            )},  请分析该数据并给出分析结果`;
    ...
    watch: {
        currentRepository: {
            handler: async function (newVal) {
                this.temp = await this.fetchData(
